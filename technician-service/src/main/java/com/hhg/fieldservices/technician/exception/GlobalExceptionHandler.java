...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTechnicianNotFound(TechnicianNotFoundException ex) {
    ...
    /**
     * Handle TechnicianValidationException
     */
    @ExceptionHandler(TechnicianValidationException.class)
    public ResponseEntity<ErrorResponse> handleTechnicianValidation(TechnicianValidationException ex) {
